package net.kkiwieee.kkiwieeemod.sound;
...
public class ModSounds {
    ...
    public static final SoundEvent METAL_DETECTOR_NOT_FOUND = registerSoundEvent("metal_detector_not_found");
    ...
    public static SoundEvent registerSoundEvent(String name) {
        Identifier id = new Identifier(KkiwieeeMod.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {KkiwieeeMod.LOGGER.info("Registering Sounds for " + KkiwieeeMod.MOD_ID);
    }
}
