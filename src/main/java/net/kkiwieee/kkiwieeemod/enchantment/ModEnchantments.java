...
public class ModEnchantments {
    ...
    public static Enchantment VEIN_MINE = register("vein_mine", new VeinMinerEnchantment(Enchantment.Rarity.VERY_RARE, EnchantmentTarget.DIGGER, EquipmentSlot.MAINHAND));
