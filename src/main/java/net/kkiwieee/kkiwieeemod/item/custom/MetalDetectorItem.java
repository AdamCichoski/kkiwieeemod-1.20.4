package net.kkiwieee.kkiwieeemod.item.custom;

import net.kkiwieee.kkiwieeemod.sound.ModSounds;
import net.kkiwieee.kkiwieeemod.util.ModTags;
...
public class MetalDetectorItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.kkiwieeemod.metal_detector.tooltip"));
